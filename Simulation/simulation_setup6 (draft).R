# Simulation Setup 6: Simulation for empirical power of One sample test (Dirichlet-Multinomial distribution)
...
type1err   <- 0.05 
diff.rate  <- 0.05 # the difference rate between null parameter and alternative 
