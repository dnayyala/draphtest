dm.wald <- function(x, y, mu.x, mu.y = NULL, alpha.null = NULL, alpha.x, alpha.y = NULL,  type = "one"){
    ...
    #' @param x A data matrix of size $p \times n$ generated from [p]-dimensional Dirichlet-Multinomial distribution. 
    #' @param y A data matrix of size $p \times n$ generated from [p]-dimensional Dirichlet-Multinomial distribution. 
