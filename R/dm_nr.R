dm.nr <- function(x, mu = NULL, alpha = NULL, tol = 1e-4, maxiters = 1e2){
    #' @title Newton-Raphson for Dirichlet-multinomial
    #' 
    #' @description Newton-Rapshon algorithm to estimate parameter alpha (or theta) of the Dirichlet-multinomial distribution
